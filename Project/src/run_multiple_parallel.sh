...
run_command() {
    ...
    list=$2
    iteration=$3
    python main.py "1000" "../data/multiplex_overlap_$overlap/list_multiplex_$list.txt" "../output_files/output_file_katz_$overlap/list_$list/iteration_$iteration.txt"
}
